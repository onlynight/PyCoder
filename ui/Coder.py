...
__filename__ = "Editor.py"
__author__ = "only.night@qq.com"
...
class Coder(QWidget):
	...
	def __init__(self,parent=None):
		super(Coder, self).__init__(parent)
	...
	def linesChanged(self):
		...
		self.scintilla.setMarginWidth(0, self.fontmetrics.width(temp) + 5)
		pass

	def textChanged(self):
		print("textChanged")
		self.scintilla.autoCompleteFromAll()
		pass
	...
	def __init_scintilla__(self):
		...
		self.scintilla.setText(open("ui/Coder.py",encoding="UTF8").read())
		self.scintilla.setMarginWidth(0, self.fontmetrics.width(str(self.scintilla.lines())) + 5)

		"""
		scrollbar = ReadStyleSheet.ReadStyleSheetFile("Scintilla/stylesheet/scrollbar.css")
		scintilla = ReadStyleSheet.ReadStyleSheetFile("Scintilla/stylesheet/scintilla.css")
		common = ReadStyleSheet.ReadStyleSheetFile("Scintilla/stylesheet/common.css")
